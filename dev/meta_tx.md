...
https://github.com/Smart Energy Chain/metatx-Java-demo
...
Smart Energy Chain officially provides a meta transaction service with a fee subsidy based on the caller's `BTC` holdings.
...
https://meta-mainnet.SEPlveblockchain.io
