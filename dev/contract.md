# Contract
`Smart Energy Chain` uses `EVM` for contract execution.See [Solidity](https://docs.soliditylang.org/en/v0.7.1/#) for detail.
...
module.exports = {
  networks: {
    testnet: {
      provider: () => new HDWalletProvider(mnemonic, 'https://testnet-rpc.SEPlveblockchain.io/'),
      network_id: 14324
    },
    mainnet: {
      provider: () => new HDWalletProvider(mnemonic, 'https://rpc.SEPlveblockchain.io/'),
      network_id: 3424
    }
  },
